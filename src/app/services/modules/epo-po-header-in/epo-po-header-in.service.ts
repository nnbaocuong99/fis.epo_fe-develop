...
export class EpoPoHeaderInService extends HttpService {
  constructor() {
    super();
    this.url = this.origin + 'epo-po-header-in';
  }
  ...
  public export(requestPayload?: RequestPayload): Observable<any> {
    return this.exportFile('/export', requestPayload, 'Báo cáo đồng bộ PO ', true);
  }
