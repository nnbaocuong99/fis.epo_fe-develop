...
export class EpoApHeader1InService extends HttpService {
  constructor() {
    super();
    this.url = this.origin + 'epo-ap-header-1-in';
  }
  ...
  public export(requestPayload?: RequestPayload): Observable<any> {
    return this.exportFile('/export', requestPayload, 'Báo cáo đồng bộ hóa đơn ', true);
  }
}
