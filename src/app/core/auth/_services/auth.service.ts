...
export class AuthService extends HttpService {
    ...
    public authenticateAzureAD(body: any, isSpinner?: boolean): Observable<Account> {
        return this.intercept(this.httpClient.post<Account>(this.url + '/authenticate-azure-ad', JSON.stringify(body),
