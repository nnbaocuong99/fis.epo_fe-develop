...
import * as config from './conformity.config';
...
export class ConformityComponent extends BaseListComponent implements OnInit {
  ...
  public onBtnRegisteredClick(id: string): void {
    this.router.navigate([`conformity/registered/${id}`], { relativeTo: this.activatedRoute });
  }
