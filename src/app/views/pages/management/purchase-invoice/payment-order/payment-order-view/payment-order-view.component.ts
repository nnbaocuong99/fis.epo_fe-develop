...
export class PaymentOrderViewComponent extends BaseFormComponent implements OnInit {
  ...
  public goBack(): void {
    this.location.back();
    // this.router.navigate([`payment-order/list/${this.currentPiId}`], { relativeTo: this.route.parent });
  }

  public goToEdit(): void {
    this.router.navigate([`payment-order/edit/${this.currentExpenseId}`], { relativeTo: this.route.parent });
  }
