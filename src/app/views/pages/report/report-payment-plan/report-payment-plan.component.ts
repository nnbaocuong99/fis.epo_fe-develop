...
@Component({
  selector: 'app-report-payment-plan',
  templateUrl: './report-payment-plan.component.html',
  styleUrls: ['./report-payment-plan.component.scss']
})
export class ReportPaymentPlanComponent implements OnInit {
  ...
  public exportPaymentPlan(): void {
    this.reportXNKService.exportPaymentPlan(this.request).subscribe(m => {
