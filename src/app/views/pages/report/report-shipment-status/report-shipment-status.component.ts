...
@Component({
  selector: 'app-report-shipment-status',
  templateUrl: './report-shipment-status.component.html',
  styleUrls: ['./report-shipment-status.component.scss']
})
export class ReportShipmentStatusComponent implements OnInit {
  ...
  public exportShipmentStatus(): void {
    this.reportXNKService.exportShipmentStatus(this.request).subscribe(m => {
