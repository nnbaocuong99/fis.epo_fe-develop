...
@Component({
  selector: 'app-report-order-fulfillment-time-by-supplier',
  templateUrl: './report-order-fulfillment-time-by-supplier.component.html',
  styleUrls: ['./report-order-fulfillment-time-by-supplier.component.scss']
})
export class ReportOrderFulfillmentTimeBySupplierComponent implements OnInit {
  ...
  public exportOrderFulfillmentTimeBySupplier(): void {
    this.reportXNKService.exportOrderFulfillmentTimeBySupplier(this.request).subscribe(m => {
