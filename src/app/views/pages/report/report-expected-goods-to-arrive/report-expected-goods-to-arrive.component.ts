...
@Component({
  selector: 'app-report-expected-goods-to-arrive',
  templateUrl: './report-expected-goods-to-arrive.component.html',
  styleUrls: ['./report-expected-goods-to-arrive.component.scss']
})
export class ReportExpectedGoodsToArriveComponent implements OnInit {
  ...
  public exportExpectedGoodsToArrive(): void {
    this.reportXNKService.exportExpectedGoodsToArrive(this.request).subscribe(m => {
