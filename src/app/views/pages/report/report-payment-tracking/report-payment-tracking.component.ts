...
@Component({
  selector: 'app-report-payment-tracking',
  templateUrl: './report-payment-tracking.component.html',
  styleUrls: ['./report-payment-tracking.component.scss']
})
export class ReportPaymentTrackingComponent implements OnInit {
  ...
  public exportPaymentTracking(): void {
    this.reportXNKService.exportPaymentTracking(this.request).subscribe(m => {
