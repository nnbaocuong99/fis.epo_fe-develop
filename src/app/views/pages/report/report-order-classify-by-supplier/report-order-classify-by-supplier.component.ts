...
@Component({
  selector: 'app-report-order-classify-by-supplier',
  templateUrl: './report-order-classify-by-supplier.component.html',
  styleUrls: ['./report-order-classify-by-supplier.component.scss']
})
export class ReportOrderClassifyBySupplierComponent implements OnInit {
  ...
  public exportOrderClassifyBySupplier(): void {
    this.reportXNKService.exportOrderClassifyBySupplier(this.request).subscribe(m => {
